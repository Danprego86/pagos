...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var datos = DatosGlobales()//Exporte de datos previamente ingresados
        var Id = UUID.randomUUID()//Numero random para ID
                ...
                if (!binding.totalPagar.text.isNullOrEmpty() &&
                    ...
                    ServiceCliente.authorization(authReq) {
                       ...
                       //     val databaseHandler: DatabaseHandler = DatabaseHandler(this)
                            if (receiptId != null && rrn != null && receiptId != "" && rrn != "" && statusCode != "" && statusDescription != "") {

                                lifecycleScope.launch(Dispatchers.IO) {

                                    try{
                                        bookDao.addTransaccion(                  AutResponseEntity(
                                            receiptId,
                                            rrn,
                                            statusCode,
                                            statusDescription
...
//                                }
        ...
        // initRecycleView() //Llamar a la funcion para mostrar en el movil
        ...
        //val recyclerView = findViewById<RecyclerView>(R.id.recyclerView)
         ...
         binding.recyclerview.adapter = Adaptador(DB.listaTX)
...
//    private fun testDB(){
//        lifecycleScope.launch(Dispatchers.IO) {
// bookDao.addTransaccion(AutResponseEntity("0","0","0","0"))
//        }
//
//    }
